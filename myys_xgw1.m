...
F=imread('C:\Users\Yanan\Desktop\毕业设计\四路照片\实景\前\前外1.jpg');%先畸变矫正
F=undistortImage(F,JF);
B=imread('C:\Users\Yanan\Desktop\毕业设计\四路照片\实景\后\后外1.jpg');
B=undistortImage(B,JB);
L=imread('C:\Users\Yanan\Desktop\毕业设计\四路照片\实景\左\左外1.jpg');
L=undistortImage(L,JL);
R=imread('C:\Users\Yanan\Desktop\毕业设计\四路照片\实景\右\右外1.jpg');
...
Q=F+L+B+R;%全景图
imshow(Q);
%imwrite(Q,'C:\Users\Yanan\Desktop\毕业设计\四路照片\实景\融合\室外效果1.jpg');