...
%前路拼接矩阵
ip=[612,421;1309,422;378,652;1543,659];%四个原坐标，由角点检测得到[612,421;1309,422;378,657;1543,659]
...
vFR=R4/F4;%不用
 ...
 L_trans=vLF*L_trans;%三个通道像素值都乘
 B_trans=(vLF*vBL)*B_trans;
 R_trans=(1/vFR)*R_trans;%改
...
Q=Q1+Q2;
imshow(Q);
%imwrite(Q,strcat('C:\Users\Yanan\Desktop\毕业设计\四路照片\融合\递乘亮度-拼接融合图像t=',num2str(t),'.jpg'));
%save pblg.mat  t a1max a2max a3max a4max x1 y1 x2 y2 x3 y3 x4 y4 Q TF TB TL TR vLF vBL vFR